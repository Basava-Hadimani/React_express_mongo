//this renders dropdown option without checkbox
/*
    disable: used for child selection, this will disable from selecting option- boolean
    isClearMe: clears the selected option- boolean
    isRequired: just mandatory sign show, the calling function should handle - boolean
    isChildRelation: if the current dropdown is child of a parent - boolean
    isParentChanges: checks if the parent value is changed and clears the child values- boolean

    required fields-
    onSelect: this is prop function whose arguments are name,selectedOption name should be unique from the parent - function required
    keyId: the key id used to uniquely identify the select div click by calling class - number required
    name: which will be displayed on top of the section - string
    label: what to be displayed inside the box,  for user info- string
    dropDownList: the list of the dropdowns- array

    Eg file: SearchParamsSec.js
